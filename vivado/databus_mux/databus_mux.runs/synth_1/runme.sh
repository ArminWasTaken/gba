...
HD_PWD='C:/Users/nccas/VivadoWorkspace/gba/vivado/databus_mux/databus_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log databus_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source databus_mux.tcl
