...
HD_PWD='C:/Users/nccas/VivadoWorkspace/gba/vivado/ALU_block/ALU_block.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_block.tcl
